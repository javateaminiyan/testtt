...
public class PaymentHistoryAdapterShared extends RecyclerView.Adapter<PaymentHistoryAdapterShared.MyViewHolder> {

    ArrayList<PaymenyHistoryBean> paidList;
    Context mContext;
    PaymentHistoryAdapter.Ipaidhistory ipaidhistory;

    public PaymentHistoryAdapterShared(Context context, ArrayList<PaymenyHistoryBean> paidList, PaymentHistoryAdapter.Ipaidhistory ipaidhistory) {
    ...
    @NonNull
    @Override
    public PaymentHistoryAdapterShared.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.paid_history_item_new, parent, false);

        return new PaymentHistoryAdapterShared.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull final PaymentHistoryAdapterShared.MyViewHolder holder, int position) {
        ...
        holder.imgDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Shared_PaymentHistory shared_paymentHistory = (Shared_PaymentHistory) mContext;
                try {
                    shared_paymentHistory.taxBalancePayment(Integer.valueOf(paidHistory.getmTaxNo()),paidHistory.getmDistrict(),
